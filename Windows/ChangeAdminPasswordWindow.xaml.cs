...
namespace ESCenter.Windows
{
    public partial class ChangeAdminPasswordWindow : Window
    {
        ...
        private void SaveButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                MessageBox.Show("Current username cannot be empty.", "Validation", MessageBoxButton.OK, MessageBoxImage.Warning);
                return;
            }

            if (string.IsNullOrWhiteSpace(NewUsernameBox.Text))
            {
                MessageBox.Show("New username cannot be empty.", "Validation", MessageBoxButton.OK, MessageBoxImage.Warning);
                return;
            }
            ...
            if (!changed)
            {
                MessageBox.Show("Current admin credentials are incorrect.", "Validation", MessageBoxButton.OK, MessageBoxImage.Warning);
                return;
            }
